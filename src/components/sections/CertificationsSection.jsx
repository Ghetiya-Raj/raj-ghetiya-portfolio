...
const certifications = [
  {
    ...
    date: 'Jul–Oct 2024',
    credentialUrl: 'https://drive.google.com/file/d/18sg2hmDyKHxQ-W1CFJNRC6H2BgVtc_yD/view?usp=drive_link',
    skills: ['Data Structures', 'Algorithms', 'Java'],
    description: '12-week NPTEL-certified course in Data Structures and Algorithms using Java (IIT Kharagpur), securing 80% with Elite distinction. Covered core DSA concepts including recursion, sorting, searching, trees, graphs, and algorithmic problem-solving.',    
    color: '#7C3AED',
  },
  {
  id: 2,
  ...
  date: 'Aug 2024',
  credentialUrl: 'https://drive.google.com/file/d/1dFsAoP9ONlWjmZwWJ3SeG2ZJVI6s8ap_/view?usp=drive_link',
  skills: ['Java 11', 'OOP', 'Core Java', 'Exception Handling', 'Collections'],
  description: 'Completed Java 11 Essentials certification covering core Java concepts, object-oriented programming principles, exception handling, and modern Java features.',
  color: '#EA580C',
},
  {
  id: 3,
  ...
  issuer: 'Apna College',
  date: '2025',
  credentialUrl: 'https://drive.google.com/file/d/1SAwDG1PU83H6kdPkcfuE0DwHMr0xSvQu/view?usp=drive_link',
  skills: ['HTML', 'CSS', 'JavaScript', 'React', 'Node.js', 'MongoDB'],
description: 'Full-stack web development certification focused on MERN stack architecture, client-server communication, RESTful API design, authentication workflows, and deployment fundamentals.',
  color: '#3B82F6',
},
  {
  id: 4,
  ...
  issuer: 'HackerRank',
  date: 'Feb 2025',
  credentialUrl: 'https://drive.google.com/file/d/1ItF0SxTlk0gt6PGUJ83dgSqw9aUCITb5/view?usp=drive_link',
  skills: ['Python', 'Problem Solving', 'Data Types', 'Loops', 'Functions'],
  description: 'Validated foundational Python programming skills through HackerRank’s skill certification assessment, covering core syntax, control structures, functions, and problem-solving concepts.',
  color: '#0D9488',
},
 {
  id: 5,
  ...
  issuer: 'HackerRank',
  date: 'July 2025',
  credentialUrl: 'https://drive.google.com/file/d/1Dt9ayxwT4Qm_dRrJn_2CR_fk8YPRfh4y/view?usp=drive_link',
  skills: [
  ...
  description:
    'Completed the HackerRank Java (Basic) Certification, showcasing strong command over core Java programming, OOP concepts, logical control structures, and practical coding problem-solving through a standardized technical assessment.',
  color: '#F59E0B',
},
 {
  id: 6,
  title: 'Backend Development and API Creation',
  issuer: 'Coursera (Authorized by Packt)',
  date: 'Sep 2025',
  credentialUrl: 'https://drive.google.com/file/d/1falacB793UHpSeH4ynnYxbjxwHmQceZt/view?usp=drive_link',
  skills: ['Node.js', 'Express', 'REST API', 'Backend Architecture', 'API Development'],
  description: 'Certification focused on backend engineering principles, RESTful API design, server-side architecture, request handling, and scalable application development using Node.js and Express.',
  color: '#0891B2',
},
